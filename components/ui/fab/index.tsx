...
const Fab = React.forwardRef<React.ComponentRef<typeof UIFab>, IFabProps>(function Fab({ size = "md", placement = "bottom right", className, ...props }, ref) {
	return (
		<UIFab
			ref={ref}
			{...props}
...
const FabLabel = React.forwardRef<React.ComponentRef<typeof UIFab.Label>, IFabLabelProps>(function FabLabel({ size, isTruncated = false, bold = false, underline = false, strikeThrough = false, className, ...props }, ref) {
